...
<div class="entry-content-card">
    ...
    <div class="entry-actions">
        <div class="btn-group">
            ...
            <button onclick="confirmDelete(<?= $entri['id'] ?>)" class="btn btn-sm btn-light"><i class="bi bi-trash me-1"></i> Delete</button>
        </div>
    </div>
    ...
    <div class="entry-meta">
        ...
        <span class="meta-item"><i class="bi bi-star me-1"></i> <?= $entri['rating'] ?> out of 5</span>
    </div>
    ...
    <div class="row g-5">
        ...
        <div class="col-lg-4">
            <h5 class="section-title">Photo Gallery</h5>
            <div class="gallery-sidebar">
                <?php foreach($galeri as $foto): ?>
                    <img src="assets/uploads/<?= htmlspecialchars($foto['nama_file']) ?>" alt="Gallery photo">
                <?php endforeach; ?>
            </div>
        </div>
    </div>
