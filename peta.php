...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        lokasiData.forEach(function(lokasi) {
            ...
            var popupContent = `<div class="text-center" style="width: 160px;"><img src="assets/uploads/${lokasi.foto_utama}" class="img-fluid rounded mb-2" alt="${lokasi.judul}"><h6 class="mb-1">${lokasi.judul}</h6><a href="entri.php?id=${lokasi.id}" class="btn btn-sm btn-primary">View Story</a></div>`;
